/**
 *Submitted for verification at hecoinfo.com on 2021-09-05
*/
...
contract allowanceCrowdsale is Context, Ownable, ReentrancyGuard{
  ...
  /**
    ...
    function remainingTokens() public view returns (uint256) {
        ...
        return token.balanceOf(_tokenWallet).sub(token.allowance(_tokenWallet, address(this)));
    }
  ...
  function changeRate (uint256 _rate) public {
    ...
    function buy() public payable nonReentrant {
        ...
        token.safeTransferFrom(_tokenWallet, msg.sender, amount);
